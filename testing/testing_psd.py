...
psd_test('pumpVial', params=dict(volume = 1200, speed = 20, times= 1)) 
#psd_test('pumpMix', params=dict(V1 = 0, V2 = 0, V3 = 0, V4 = 0, V5 = 0, V6 = 1000, speed = 12, mix = 1, times= 3, cell = True))
