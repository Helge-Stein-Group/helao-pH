...
test_fnc(dict(soe=[f'boss/boss_{j}',f'orchestrator/modify_{2*j}',f'psd/pumpMix_{2*j}',f'orchestrator/modify_{2*j+1}',f'camera/takeImage_{j}', f'psd/pumpVial_{j}', f'psd/pumpMix_{2*j+1}',f'image/extractColorFromRoi_{j}', f'image/prepareData_{j}'], 
